...
plot_graph(normalized_compression, compression_x_labels, "Compression Performance (Normalized to ZSTD)", "fig7_a.png")
plot_graph(normalized_decompression, decompression_x_labels, "Decompression Performance (Normalized to ZSTD)", "fig8_a.png")
